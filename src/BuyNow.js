...
export default function Buynow() {
    return (
        <div>
            ...
            <div style={{ margin: '10rem 0px 3rem', padding: '3% 8%' }}>
                <div className="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-grid-xs-12">
                    <div className="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-align-items-xs-center MuiGrid-justify-content-xs-center MuiGrid-grid-xs-12" style={{ padding: '1rem', borderRadius: '28px', backgroundImage: 'url("https://www.paperplanetech.co/static/media/bgHero.edc64e6179ecb05ea143.png")' }}>
